...
1. Run `git submodule update --init --depth=1 --jobs=32`
...
this to ensure your patch compiles properly. Do not interrupt this
step and let it run till completion, this is critical for quality
assurance of your patch.
