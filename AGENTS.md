...
Use `echo :q | HADRIAN_ARGS=-j ./hadrian/ghci-multi -j` to
typecheck GHC code without actually compiling it. When you put up a
GHC patch, always do this to ensure your patch typechecks. Do not
interrupt this step, the output may appear as if the command is stuck,
but GHC is indeed running.
